  ...
  return (
    <div className="flex relative mb-9 lg:w-9/12 w-10/12 lg:basis-1/2 text-primary-gray self-center  h-[calc(100vh_-_65px)]">
      ...
      <textarea
        type="text"
        rows="24"
        className={`w-full px-4 rounded-2xl focus:outline-none border dark:text-white resize-none dark:border-white h-24 border-primary-gray text-sm py-2 scrollbar-hide bg-white dark:bg-[#0a0908] ${
