  ...
  return (
    <>
      ...
      <div
        ...
        className={` ${
          !user.firstName ? 'landscape:lg:h-[40svh] ' : 'landscape:lg:h-[70svh]'
        } dark:text-white dark:bg-[#0a0908]/60 bg-white/60 -translate-y-full fixed  w-screen opacity-95 z-30  landscape:h-[calc(100svh_-_56px)] portrait:h-[100svh] `}
      >
